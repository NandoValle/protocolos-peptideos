...
<p>As <strong>catorze páginas listadas abaixo</strong> são diferentes. Cada número nelas foi levantado por mim
...
<strong>174 compostos distintos</strong>.</p>
...
<p class="nota"><strong>A coluna não soma 174.</strong> Duas páginas são segundo corte dos mesmos compostos,
