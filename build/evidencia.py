...
<p>As <strong>dez páginas listadas abaixo</strong> são diferentes. Cada número nelas foi levantado por mim
...
<ul>
  ...
  <li><strong>27 itens continuam marcados como não conferidos</strong> nas páginas de suplementos, fitoterápicos e
