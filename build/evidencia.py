...
<tr>
  ...
  <td>6</td>
  <td>A única página deste site conferida contra um <strong>gabarito oficial</strong>. As cinco escadas de
      titulação de semaglutida e tirzepatida <strong>batem com a bula da FDA</strong>, degrau por degrau. O que
      faltava era a <strong>tarja preta</strong> — e ela faltava nas nove páginas de GLP-1</td>
</tr>
<tr>
