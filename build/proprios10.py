    ...
    secoes=[
        ...
        dict(h="O número", tipo="p", corpo=[
            ...
            linhas=[
                ...
                ["Peptídeos e compostos de protocolo", "<strong>4</strong>", "<strong>39</strong>",
                ...
                ["Nootrópicos", "<strong>4</strong>", "<strong>9</strong>",
                 "Modafinila (STAVIGILE), armodafinila (NUVIGIL), piracetam (NOOTROPIL), sulbutiamina (ARCALION) e seis benfotiaminas. Tianeptina, vinpocetina, oxiracetam, aniracetam, huperzina A, citicolina e alfa-GPC: nenhum"],
