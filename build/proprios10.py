...
"proprio_anvisa": dict(
    ...
    nota_refs=(f'Cada número desta página veio do dado aberto oficial da ANVISA, baixado em {_DT}'
              ', contando apenas registros com situação Ativo. <strong>Esta página não usa o PubMed</strong> — '
